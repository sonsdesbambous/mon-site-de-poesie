...
traductions:
  - texte_fr: |-
      La maison veut s’envoler,
      le chemin veut s’écouler,
      la rivière veut se dresser,
      les choses veulent leur nom,
      les faits veulent leur vie.

      Les mots relient,
      divisent.

      Un locuteur, un auditeur ;
      un locuteur, des auditeurs ;
      des locuteurs, un auditeur ;
      des locuteurs, des auditeurs.

      L’auditeur écoute en silence,
      le locuteur parle avec indifférence,
      l’auditeur se débrouille pour comprendre,
      le locuteur s’arrange pour se taire,
      laissant la langue créer
      librement des sens.
